const urlModel = require("../model/userModel");
...
const redisClient = redis.createClient(
  13190,
  "redis-19122.c212.ap-south-1-1.ec2.cloud.redislabs.com",
  { no_ready_check: true }
);
redisClient.auth("WHr6bdJE4XBlqCiWgyCoTSU8Q59Vj8V5", function (err) {
  if (err) throw err;
});
